...
//localStorage.setItem("usuario_foto","https://media-exp1.licdn.com/dms/image/C4E03AQHR0yPiwVtfjA/profile-displayphoto-shrink_800_800/0/1654528097336?e=2147483647&v=beta&t=pJ5UEI9qA4pBa1dte4Qr04toC5PUfeaVY-0E5dv0-QE")
...
window.onload = function() {
    if(username && user_pic){
        ...
        user_info_login_btn.setAttribute('class','btn btn-outline-light btn-login')
        ...
        user_info_cadastro_btn.setAttribute('class','btn btn-outline-light btn-register')
